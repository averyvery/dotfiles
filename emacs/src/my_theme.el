...
(deftheme birds-of-paradise-custom
  "Port of the brown-based warm light-on-dark theme by Joe Bergantine.")

(let ((brown-1 "#37302f") (brown-2 "#6b5e53") (brown-3 "#4b3f3e")
                          (brown-4 "#52473e") (brown-5 "#7d6865")
                          (brown-6 "#393333") (brown-7 "#282222")
...
(provide-theme 'birds-of-paradise-custom)

;;; birds-of-paradise-custom-theme.el ends here
