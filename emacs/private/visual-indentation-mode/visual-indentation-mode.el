...
(defface visual-indentation-light-face
  ;; '((((background light)) (:background "#2e262e"))
    ;; (((background dark))  (:background "#221b22")))
  '((((background light)) (:background "#0d2518"))
    (((background dark))  (:background "#00291d")))
  "Face for highlighting odd indents."
  :group 'visual-indentation-mode)

(defface visual-indentation-dark-face
  ;; '((((background light)) (:background "#221b22"))
    ;; (((background dark))  (:background "#2e262e")))
  '((((background light)) (:background "#00291d"))
    (((background dark))  (:background "#0d2518")))
